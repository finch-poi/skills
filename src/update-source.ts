 ...
 * Returns null for legacy generic-git lock entries whose source was normalized
 * to an ambiguous owner/repo shorthand. Those entries lack the original host, so
 * reinterpreting them as GitHub would be unsafe.
 */
